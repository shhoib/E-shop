  ...
  return (
    <div>
        <div className="flex gap-4 items-center">
            ...
            {images.map((image,i)=>{
                return <div key={i} className={` rounded-full border-teal-300 items-center justify-center
                 ${cartProduct.selectedImg.color===image.color ? 'border-[1.5px]':'border-none'}`} onClick={()=>handleColorSelect(image)}>    
