...
const ProductDetails: React.FC<ProductDetailsProps> = ({product}) => {
    ...
    const handleSelectColor = useCallback((value:SelectedImgType)=>{
        setCartProduct((prev)=>{
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <ProductImages cartProduct={cartProduct} product={product} handleColorSelect={handleSelectColor}/>
        <div className="flex flex-col gap-1 text-slate-500 text-sm">
        <h2 className="text-3xl font-medium text-slate-70">{product.name}</h2>
        ...
        <p className="mb-2 text-slate-500 flex items-center gap-1">
          ...
          <span>Product added t cart</span>
        </p>
        ...
        <>
        <SetColor cartProduct={cartProduct} images ={product.images} handleColorSelect={handleSelectColor} />
        <Horizontal/>
